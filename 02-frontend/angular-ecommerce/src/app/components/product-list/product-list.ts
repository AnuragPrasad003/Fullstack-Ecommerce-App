...
export class ProductList implements OnInit{
 ...
 // new properties for pagination
  ...
  constructor(private productServices: ProductService,private cdr: ChangeDetectorRef,private cartService: Cart,private route: ActivatedRoute){}
  ...
  handleSearchProducts(){
    ...
    this.productServices.searchProductsPaginate(this.thePageNumber - 1,
                                                this.thePageSize,
...
//                                                     this.cdr.detectChanges(); // 👈 REQUIRED without zone.js
